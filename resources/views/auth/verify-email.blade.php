...
<html>
<head>
    <title>Verifikasi Email - Piufy</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-kirim:hover { background: #1e0f6e; }
...
<div class="left-panel">
    ...
    <div style="text-align: left;">
        <h1>Satu langkah<br>lagi menuju<br>akun kamu.</h1>
        <p>Verifikasi email kamu untuk mulai menggunakan Piufy secara penuh.</p>
    </div>
</div>
...
<div class="right-panel">
    <div class="form-box">
        ...
        <div class="icon-circle">
            <i class="bi bi-envelope-check" style="font-size: 28px; color: #13094d;"></i>
        </div>
